...
export class AmmContract extends ContractBase {
  ...
  public methods!: {
    ...
    swap: ((tokenIn: AztecAddressLike, tokenOut: AztecAddressLike, amountIn: FieldLike, amountOut: FieldLike, secret_hash: FieldLike, nonce: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
